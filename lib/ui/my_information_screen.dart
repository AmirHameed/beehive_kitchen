        ...
        child: SingleChildScrollView(
          child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
            const Padding(
              ...
              child: AppBarItem(title: AppText.STORE_INFORMATION),
            ),
            Stack(
              children: [
            ...
            _SingleProfileItemNavigation(
              title: AppText.STORE_NAME,
              name: 'Amir Hameed',
              onTap: () {
                showChangeInformationBottomSheet(context,AppText.STORE_NAME,AppText.CHANGE_FULL_NAME,'Amir Hameed');
              },
            ),
            _SingleProfileItemNavigation(
                title: AppText.EMAIL,
